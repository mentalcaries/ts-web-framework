...
})({"k4Tuz":[function(require,module,exports) {
"use strict";
...
class User {
    ...
    fetch() {
        (0, _axiosDefault.default).get(`${this.baseURL}users/${this.get("id")}`).then((response)=>{
            this.set(response.data);
        });
    }
    save() {
        const id = this.get("id");
        if (id) (0, _axiosDefault.default).put(`${this.baseURL}/users/${id}`, this.data);
        else (0, _axiosDefault.default).post(`${this.baseURL}/users`, this.data);
    }
}
...
},{"./../utils":"5By4s"}],"bMzHQ":[function(require,module,exports) {
...
},{}]},["k4Tuz","h7u1C"], "h7u1C", "parcelRequire94c2")
